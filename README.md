I've put all the POC files in the Releases section

A collection of files commonly used by threat actors in phishing campagins / waterhole attacks / etc...
...
The files just run calc.exe or msg.exe for POC, nothing malicious.
